 ...
 * @method Collection batchtransfer(array $config) 帐户转账
...
//            'biz_content' => '',
     ...
     * @throws InvalidSignException
     */
    public function token($params): Collection
    {
        $this->payload['method'] = 'alipay.open.auth.token.app';
        $this->payload['biz_content'] = json_encode($params);
        $this->payload['sign'] = Support::generateSign($this->payload);
        Events::dispatch(new Events\MethodCalled('Alipay', 'token', $this->gateway, $this->payload));

        return Support::requestApi($this->payload, true);
    }
     ...
     * @throws InvalidSignException
     */
    public function bind($params): Collection
    {
        $this->payload['method'] = 'alipay.trade.royalty.relation.bind';
        $this->payload['biz_content'] = json_encode($params);
        $this->payload['sign'] = Support::generateSign($this->payload);
        Events::dispatch(new Events\MethodCalled('Alipay', 'bind', $this->gateway, $this->payload));
     ...
     * @throws InvalidSignException
     */
    public function unbind($params): Collection
    {
        $this->payload['method'] = 'alipay.trade.royalty.relation.unbind';
        $this->payload['biz_content'] = json_encode($params);
        $this->payload['sign'] = Support::generateSign($this->payload);
        Events::dispatch(new Events\MethodCalled('Alipay', 'unbind', $this->gateway, $this->payload));
     ...
     * @throws InvalidSignException
     */
    public function queryBind($params): Collection
    {
        $this->payload['method'] = 'alipay.trade.royalty.relation.batchquery';
        $this->payload['biz_content'] = json_encode($params);
        $this->payload['sign'] = Support::generateSign($this->payload);
        Events::dispatch(new Events\MethodCalled('Alipay', 'queryBind', $this->gateway, $this->payload));
     ...
     * @throws InvalidSignException
     */
    public function settle($params): Collection
    {
        $this->payload['method'] = 'alipay.trade.order.settle';
        $this->payload['biz_content'] = json_encode($params);
        $this->payload['sign'] = Support::generateSign($this->payload);
        Events::dispatch(new Events\MethodCalled('Alipay', 'settle', $this->gateway, $this->payload));
     ...
     * @throws InvalidSignException
     */
    public function qrcode($params): Collection
    {
        $this->payload['method'] = 'alipay.open.app.qrcode.create';
        $this->payload['biz_content'] = json_encode($params);
        $this->payload['sign'] = Support::generateSign($this->payload);
        Events::dispatch(new Events\MethodCalled('Alipay', 'qrcode', $this->gateway, $this->payload));
     ...
     * @throws InvalidSignException
     */
    public function image($params): Collection
    {
        $this->payload['method'] = 'ant.merchant.expand.indirect.image.upload';
        $this->payload['sign'] = Support::generateSign(array_merge($this->payload, $params));
        Events::dispatch(new Events\MethodCalled('Alipay', 'image', $this->gateway, array_merge($this->payload, $params)));

        return Support::requestApi(array_merge($this->payload, $params), true);
    }
     ...
     * @throws InvalidSignException
     */
    public function shop($params): Collection
    {
        $this->payload['method'] = 'ant.merchant.expand.shop.create';
        $this->payload['biz_content'] = json_encode($params);
        $this->payload['sign'] = Support::generateSign($this->payload);
        Events::dispatch(new Events\MethodCalled('Alipay', 'shop', $this->gateway, $this->payload));
     ...
     * @throws InvalidSignException
     */
    public function queryShop($params): Collection
    {
        $this->payload['method'] = 'ant.merchant.expand.order.query';
        $this->payload['biz_content'] = json_encode($params);
        $this->payload['sign'] = Support::generateSign($this->payload);
        Events::dispatch(new Events\MethodCalled('Alipay', 'queryshop', $this->gateway, $this->payload));
     ...
     * @throws InvalidSignException
     */
    public function orderSync($params): Collection
    {
        $this->payload['method'] = 'alipay.merchant.order.sync';
        $this->payload['biz_content'] = json_encode($params);
        $this->payload['sign'] = Support::generateSign($this->payload);
        Events::dispatch(new Events\MethodCalled('Alipay', 'ordersync', $this->gateway, $this->payload));

        return Support::requestApi($this->payload, true);
    }

    /**
     * Merchant Item File Upload
     *
     * @param array $params
     * @throws GatewayException
     * @throws InvalidConfigException
     * @throws InvalidSignException
     */
    public function itemUpload($params): Collection
    {
        $this->payload['method'] = 'alipay.merchant.item.file.upload';
        $this->payload['sign'] = Support::generateSign(array_merge($this->payload, ['scene' => 'SYNC_ORDER']));
        Events::dispatch(new Events\MethodCalled('Alipay', 'itemupload', $this->gateway, $this->payload));

        return Support::requestFileApi(array_merge($this->payload, ['scene' => 'SYNC_ORDER']), true);
    }
}
